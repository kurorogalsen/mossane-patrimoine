    ...
    <main id="sport" className="container column">
      ...
      <section className="col-11 col-md-10 col-lg-9 col-xl-8 col-xxl-7">
        ...
        <p data-aos="zoom-in">
          ...
          mérite d’être préparée. Que vous soyez en début de carrière ou sportif
          ...
          votre carrière sereinement. Mettre des photos de sports : football
          tennis basketball lutte mma boxe.
        </p>
