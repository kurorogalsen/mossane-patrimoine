...
function Cabinet() {
  ...
  const consultantInfo = [
    ...
    },
    {
      ...
      urlImg: null,
      name: "Cheikh Diallo",
      text: "Expert comptable, formateur",
    },
  ];
  return (
    <main id="cabinet" className="container column">
      ...
      <h3 data-aos="zoom-in">Nous comptons parmi nos consultants:</h3>
      <div className="container row row-top">
